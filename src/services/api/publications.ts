...
const PUBLICATIONS_PATH = '/printed-clipping/Info4AINews/publications/list'
...
export function createEditionPdf(publication: PublicationDto, pages: PageData[] = [emptyPage('1')]): PdfFile {
  return {
